...
person reusable across dumps, ads and lipsync clips. Whose the face is follows
who cast it: through a key or connection bound to a brand, it is that brand's
and only that brand's credentials see it; cast by a person, it is the
workspace's. One face for several client brands is cast once under each.
